...
int check_flag_4(char *query){
	...
	// fake key
	unsigned char flag_4_key[] = {0xd5,0xfd,0x3b,0x5c,0x19,0x80,0xed,0x57,0xd8,0x34,0xd8,0x40,0xea,0xe9,0xca,0x4b,0xe8,0x4a,0x68,0x4e,0x43,0xa8,0xae,0x77,0x40,0xe3,0x01,0x4b,0xcc,0xef,0x99,0x2a,0x5d,0x9f,0x66,0x54};
  ...
  struct xod *xor_data;
	...
	if(!cpid){
		...
		memcpy(tmp_ptr, flag_4_key, BUFFER_LEN);
